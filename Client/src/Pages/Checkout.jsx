...
const Checkout = () => {
    ...
    const getCurrentLocation = () => {
        // First try to get location from userData if available
        if (userData?.location?.coords?.length >= 2) {
            ...
            <div className="w-full max-w-[900px] bg-white rounded-2xl shadow-xl p-6 space-y-6">
                ...
                <section>
                    ...
                    <div className="flex gap-2 mb-3">
                        <input type="text" className="flex-1 border border-gray-300 rounded-lg p-2 text-sm focus:outline-none focus:ring focus:ring-[#ff4d2d]" placeholder="Delivery Address" value={addressInput} onChange={(e) => setAddressInput(e.target.value)}/>
                        <button className="bg-[#ff4d2d] hover:bg-[#e64526] text-white px-3 py-2 rounded-lg flex items-center justify-center cursor-pointer" onClick={getLatLngByAddress}><FiSearch size={18}/></button>
                        <button className="bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 rounded-lg flex items-center justify-center cursor-pointer" onClick={getCurrentLocation}><BiCurrentLocation size={18}/></button>
                    </div>
                ...
                {/* Order Summary */}
                <section >
                    <h2 className="text-lg font-semibold mb-3 text-gray-800">Order Sumamry</h2>
                ...
                <button className="w-full bg-[#ff4d2d] hover:bg-[#e64526] text-white py-3 rounded-xl font-semibold  cursor-pointer" onClick={handlePlaceOrder}>{paymentMethod === 'COD' ? 'Place Order' : 'Pay Now'}</button>
            </div>
        </div>
    );
};
